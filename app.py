...
def main():
    ...
    st.markdown("OVERVIEW: PDF QueryBot is an innovative chatbot application designed to enhance the way users interact with their PDF documents. With the ability to upload PDF files, users can easily extract information and receive relevant answers to their questions in real time, streamlining research, data analysis, and information retrieval....!")
